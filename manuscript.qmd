...
p1 <- ggplot2::ggplot(data = dat_top,
...
# Heatmap of severity scores for top phenotypes
p2 <- ggplot2::ggplot(data = dat_middle,
                      ggplot2::aes(x=variable, y=hpo_name, fill=value)) +
  ggplot2::geom_tile() +
  ggplot2::scale_y_discrete(limits=rev) +
  scale_fill_ghibli_d("YesterdayMedium", direction = -1) +
...
# Heatmap of severity scores for top phenotypes
p3 <- ggplot2::ggplot(data = dat_bottom,
                      ggplot2::aes(x=variable, y=hpo_name, fill=value)) +
  ggplot2::geom_tile() +
  ggplot2::scale_y_discrete(limits=rev) +
  scale_fill_ghibli_d("YesterdayMedium", direction = -1) +
...
# Combine the plots
p_combined <- patchwork::wrap_plots(p1, p2, p3, ncol = 3)
